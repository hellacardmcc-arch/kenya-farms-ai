  ...
  return (
    <div className="admin-profile-view">
      <header className="admin-header">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ opacity: 0.8 }}>Profile Settings</p>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <button onClick={() => navigate('/')} style={{ background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white', padding: '8px 16px', borderRadius: '8px', cursor: 'pointer' }}>
              Dashboard
            </button>
            ...
            <button onClick={() => { logout(); navigate('/login'); }} style={{ background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white', padding: '8px 16px', borderRadius: '8px', cursor: 'pointer' }}>
              Logout
            </button>
          </div>
        </div>
      ...
      <div style={{ background: 'white', borderTop: '1px solid #e2e8f0', padding: '12px 20px', display: 'flex', gap: '24px', marginTop: '20px' }}>
        <span style={{ color: '#64748b', cursor: 'pointer' }} onClick={() => navigate('/')}>🏠 Dashboard</span>
        <span style={{ color: '#3b82f6', fontWeight: '600' }}>👤 Profile</span>
        <span style={{ color: '#64748b', cursor: 'pointer' }} onClick={() => navigate('/users')}>👤 Admin Users</span>
